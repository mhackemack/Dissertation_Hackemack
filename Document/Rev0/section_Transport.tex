...
\begin{aligned}
	\Phi_{p,n} \equiv \int_{4 \pi} \, \Psi(\vec{\Omega}) \, Y_{p,n} (\vec{\Omega}) \\
	\sigma_s    \\
	Q_{p,n} \equiv 
\end{aligned}
\end{equation}
...
\centering
	...
	\begin{subfigure}[b]{0.48\textwidth}
		...
		\caption{}
	\end{subfigure}
\caption[Product Gauss-Legendre-Chebyshev angular quadrature set]{Product Gauss-Legendre-Chebyshev angular quadrature set with orders: (a) PGLC$_2^2$, (b) PGLC$_2^4$, (c) PGLC$_4^2$, (d) PGLC$_4^4$, (e) PGLC$_6^6$, and (f) PGLC$_8^8$.}
\label{fig_Sn_Angle_PGLC_Quads}
\end{figure}
