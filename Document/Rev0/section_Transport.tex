...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%   SubSection - TriGLC
\subsection{Triangular Gauss-Legendre-Chebyshev Quadrature Set}
\label{sec::Sn_Angle_TriGLC}

\begin{figure}
\centering
	\begin{subfigure}[b]{0.48\textwidth}
		\centering
		\includegraphics[width=0.92\textwidth]{figures/sec_Sn/GLC2.eps}
		\caption{}
	\end{subfigure}
	\hfill
	\begin{subfigure}[b]{0.48\textwidth}
		\centering
		\includegraphics[width=0.92\textwidth]{figures/sec_Sn/GLC4.eps}
		\caption{}
	\end{subfigure}
	\vfill
	\begin{subfigure}[b]{0.48\textwidth}
		\centering
		\includegraphics[width=0.92\textwidth]{figures/sec_Sn/GLC8.eps}
		\caption{}
	\end{subfigure}
	\hfill
	\begin{subfigure}[b]{0.48\textwidth}
		\centering
		\includegraphics[width=0.92\textwidth]{figures/sec_Sn/GLC16.eps}
		\caption{}
	\end{subfigure}
\caption[Triangular Gauss-Legendre-Chebyshev angular quadrature set]{Triangular Gauss-Legendre-Chebyshev angular quadrature that mimics the level-symmetric set of order (a) 2, (b) 4, (c) 8, and (d) 16.}
\label{fig::Sn_Angle_TriGLC_Angle_Quads}
\end{figure}
...
\centering
	...
	\begin{subfigure}[b]{0.48\textwidth}
		...
		\caption{}
	\end{subfigure}
\caption[Product Gauss-Legendre-Chebyshev angular quadrature set]{Product Gauss-Legendre-Chebyshev angular quadrature set of order (a) 2, (b) 4, (c) 8, and (d) 16.}
\label{fig::Sn_Angle_PGLC_Angle_Quads}
\end{figure}
