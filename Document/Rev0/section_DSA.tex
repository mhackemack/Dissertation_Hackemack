...
\item Perform $G$ distinct 1-group diffusion calculations for the within-group iteration error. The error residuals only contain the $g\rightarrow g$ scattering term.
...
\noindent From Eq. (\ref{eq::DSA_MJIA_WIG_diff}), we can clearly see the independent nature of these $G$ diffusion solves. Therefore, each of these within-group error correction terms can be calculated independently. 
