...
In this work, we have defined three different methodologies to accelerate thermal neutron upscattering: the Two-Grid method, the Modified Two-Grid method, and the Multigroup Richardson Acceleration method. These methods are similar in that we perform a single coarsening step for each iteration where a spectrally-collapsed, 1-group diffusion equation is the low-order error operator.
...
&+ \left(  {\bf P} {\bf A}^{-1}  {\bf X} {\bf \Sigma}  + {\bf I} \right) {\bf D}{\bf L}^{-1}  {\bf Q}
\end{aligned}
\end{equation}
...
\caption{Spectral shape of the infinite medium iteration matrices for the Multigroup Richardson Acceleration Method for the IM1 problem materials.}
