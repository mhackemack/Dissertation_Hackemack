...
\centering
	...
	\begin{subfigure}[b]{0.35\textwidth}
		...
		\caption{}
	\end{subfigure}
\caption{Contour plots of the different linear basis function on the unit square located at vertex (0,1): (a) Wachspress, (b) PWL, (c) mean value, and (d) maximum entropy.}
\end{figure}
...
\centering
	...
	\begin{subfigure}[b]{0.35\textwidth}
		...
		\caption{}
	\end{subfigure}
\caption{Contour plots of the different linear basis function on the degenerate square located at vertex (0,1): (a) Wachspress, (b) PWL, (c) mean value, and (d) maximum entropy.}
\end{figure}
