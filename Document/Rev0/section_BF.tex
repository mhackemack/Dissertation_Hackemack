...
\begin{figure}[hbt]
\centering
\includegraphics[width=0.80\textwidth]{figures/sec_BF/linear_to_quad_process.png}
...
\sum_{i=1}^{2 N_K}  b_i (\vec{x}) \vec{c}_{i,2}(\vec{x}) = \vec{q}_2 ,
\end{equation}
